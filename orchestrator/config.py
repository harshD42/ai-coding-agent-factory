...
# ── Profile ───────────────────────────────────────────────────────────────────
PROFILE = os.environ.get("PROFILE", "laptop")  # gpu | gpu-shared | laptop
...
# Later steps will use this to route to specialised agents.
# For the laptop profile everything maps to Ollama.
if PROFILE == "laptop":
...
# Fallback chain: if primary endpoint is unhealthy, try next in list
